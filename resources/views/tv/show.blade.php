...
@section('content')
                ...
                <div class="mt-12">
                    <div class="flex mt-4">
                        @foreach ($tvshow['created_by'] as $crew)
                            <div class="mr-8">
                                <div>{{ $crew['name'] }}</div>
                                <div class="text-sm text-gray-400">Vyrobil</div>
                            </div>
                    ...
                    @if (count($tvshow['videos']['results']) > 0)
                        <div class="mt-12">
                            ...
                            >
                                ...
                                <span class="ml-2">Pustiť Trailer</span>
                            </button>
                        </div>
    ...
    <div class="tv-cast border-b border-gray-800">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold">Hrajú</h2>
    ...
    <div class="tv-images" x-data="{ isOpen: false, image: ''}">
        <div class="container mx-auto px-4 py-16">
            <h2 class="text-4xl font-semibold">Obrázky</h2>
